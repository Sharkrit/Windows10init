...
Register-PSRepository -Name MyArtifactoryRepo -SourceLocation https://repo.devserver.local/api/nuget/agoda-nuget-local -InstallationPolicy Trusted -PackageManagementProvider NuGet -PublishLocation https://repo.devserver.local/api/nuget/agoda-nuget-local/myrepo
...
# Install InvokePsExec module for execute PowerShell and batch/cmd.exe code asynchronously on target Windows computers, using PsExec.exe.
# Ref: http://www.powershelladmin.com/wiki/Invoke-PsExec_for_PowerShell
...
# Testing your a sample small container
...
# You can simply run a PowerShell script from Microsoft for troubleShooting Windows Contrainer Host
